...
import { faLinkedin, faGithub, faHackerrank, faInstagram } from '@fortawesome/free-brands-svg-icons';
...
const Header = () => {
  ...
  useEffect(() => {
    setLinks([
      ...
      {
        "name": 'github',
        'url': "https://github.com/Devavanshi-Harsh?tab=repositories",
        'icon': faGithub
      },
      {
        "name": 'hackerrank',
      ...
      {
        "name": 'Instagram',
        'url': "https://www.instagram.com/ray_berlin_/",
        'icon': faInstagram
      },
    ])
